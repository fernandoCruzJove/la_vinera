...
if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['grabardatos']))
	...
	{
	$sqlgrabar = "INSERT INTO clientes(codigo, nombres, telefono,direccion) values ('$cod','$nom','$tel','$dir')";
...
}else 
{
	...
	{
			$sqlmodificar = "UPDATE clientes SET nombres='$nom',telefono='$tel',direccion='$dir' WHERE codigo=$cod";
